...
public class Bus extends Vehicle {
  ...
  /**
   * Loads Passenger onto a bus.
   *
   * @param newPassenger new passenger to be added
  ...
  /**
   * Handles the unloading and loading of passengers at a stop.
   *
  ...
  /**
   * Moves bus to next stop and updates distance accordingly.
   */
   ...
   *
   * @return effective speed of the bus
   */
  ...
  /**
   * Determines the current route of the bus.
   *
   * @return Route
   */
