...
public class Train extends Vehicle {
   ...
   * @return a passenger loaded on the train
   */
  ...
  /**
   * To unload passengers from train.
   *
   * @return the number of unloaded passengers to be
   */
  ...
  /**
   * To handle arrivals at the train stop.
   *
   * @return the number of passengers loaded and unloaded at the stop
   */
  ...
  /**
   * Move train to the next stop on the route.
   */
  ...
  /**
   * Finds out whether the route is outgoing or incoming.
   *
